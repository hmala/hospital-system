...
<div class="container-fluid bed-reservations-page">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form action="<?php echo e(route('bed-reservations.store')); ?>" method="POST" id="bedReservationForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required autofocus>
                                                ...
                                                <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($patient->id); ?>" <?php echo e((old('patient_id') == $patient->id || (isset($selectedPatient) && $selectedPatient->id == $patient->id)) ? 'selected' : ''); ?>>
                                                        <?php echo e(optional($patient->user)->name ?? 'غير معروف'); ?>
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($doctor->id); ?>" <?php echo e(old('doctor_id') == $doctor->id ? 'selected' : ''); ?>>
                                                        د. <?php echo e(optional($doctor->user)->name ?? 'غير معروف'); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" name="scheduled_date" id="scheduled_date" class="form-control form-control-lg <?php $__errorArgs = ['scheduled_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('scheduled_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="time" name="scheduled_time" id="scheduled_time" class="form-control form-control-lg <?php $__errorArgs = ['scheduled_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('scheduled_time', '09:00')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between mt-4 pt-4 border-top">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('bed-reservations.index')); ?>" class="btn btn-outline-danger btn-lg">
                            <i class="fas fa-times me-2"></i>
                            إلغاء
                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hinpabye/public_html/hospital-system/resources/views/bed_reservations/create.blade.php ENDPATH**/ ?>