    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div id="noResults" class="text-center py-5" style="display: none;">
                        ...
                        <a href="<?php echo e(route('patients.create')); ?>" class="btn btn-primary mt-3">
            ...
            <div class="mt-4 text-center">
                <a href="<?php echo e(route('inquiry.index')); ?>" class="btn btn-outline-secondary me-2">
...
searchInput.addEventListener('input', function() {
    ...
    searchTimeout = setTimeout(() => {
        fetch(`<?php echo e(route('inquiry.search.patients')); ?>?query=${encodeURIComponent(query)}`)
            .then(response => {
            ...
            .then(data => {
                ...
                data.forEach(patient => {
                    ...
                    item.href = `<?php echo e(route('inquiry.create')); ?>?patient_id=${patient.id}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/hinpabye/public_html/hospital-system/resources/views/inquiry/search.blade.php ENDPATH**/ ?>