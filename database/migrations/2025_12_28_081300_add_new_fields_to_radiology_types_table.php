...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('radiology_types', function (Blueprint $table) {
            // إضافة التصنيف الرئيسي والفرعي والملاحظات
            ...
            $table->text('notes')->nullable()->after('is_active')->comment('ملاحظات/القسم الطبي');
            
            // إزالة عمود category القديم إذا كان موجوداً
            if (Schema::hasColumn('radiology_types', 'category')) {
