                                ...
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm bg-primary rounded-circle me-3 d-flex align-items-center justify-content-center">
                                                <span class="text-white fw-bold">
                                                    {{ $doctor->user ? substr($doctor->user->name, 0, 1) : '?' }}
                                                </span>
                                            </div>
                                            <div>
                                                <strong>{{ $doctor->user ? $doctor->user->name : 'طبيب بدون بيانات' }}</strong>
                                                <br>
                                    ...
                                    <td>
                                        <span class="text-success">
                                            {{ number_format($doctor->consultation_fee) }} د.ع
                                        </span>
                                    </td>
                                    <td>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <form action="{{ route('doctors.destroy', $doctor) }}" 
                                                ...
                                                <button type="submit" class="btn btn-danger" 
                                                        title="حذف" onclick="return confirm('هل أنت متأكد من حذف الطبيب؟')">
