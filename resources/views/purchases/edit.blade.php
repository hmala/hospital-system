                        ...
                        <div class="row mb-3 align-items-center">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="tableItemSearch" class="form-control border-start-0" placeholder="بحث سريع في أسطر الفاتورة (اسم المادة، الباركود، أو السعر)..." style="border-radius: 0 10px 10px 0;">
                                </div>
                            </div>
