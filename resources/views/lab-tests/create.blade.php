                    ...
                    <form action="{{ route('lab-tests.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="main_category" name="main_category" required>
                                    ...
                                    @foreach($categories as $key => $value)
                                        <option value="{{ $key }}" {{ old('main_category') == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="subcategory" name="subcategory" value="{{ old('subcategory') }}" placeholder="اختياري">
                            </div>
                            <div class="col-md-6 mb-3">
