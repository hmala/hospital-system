...
<div class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h4 class="mb-0">طباعة جميع باركودات المنتجات</h4>
            <div>
                <button onclick="window.print()" class="btn btn-primary me-2 btn-print">
        ...
        <div class="card-body">
            <div class="alert alert-info">
                ...
                <strong>إجمالي المنتجات:</strong> {{ $products->count() }} منتج
            </div>
