...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted">أدخل بيانات الجهاز الطبي لتسجيله في النظام</p>
                </div>
                <div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form action="{{ route('medical-devices.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="usage_price" id="usage_price" class="form-control @error('usage_price') is-invalid @enderror" value="{{ old('usage_price', 0) }}" min="0" required>
                        @error('usage_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" name="last_maintenance_at" id="last_maintenance_at" class="form-control @error('last_maintenance_at') is-invalid @enderror" value="{{ old('last_maintenance_at') }}">
