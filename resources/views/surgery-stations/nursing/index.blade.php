        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">محطة التمريض</h3>
                </div>
                <div class="card-body">
                    @if(session('success'))
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $surgery->nursingStation?->nurse?->full_name ?? '-' }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('nursing-station.show', $surgery) }}" class="btn btn-sm btn-primary">
                                ...
                                @empty
                                <tr>
                                    <td colspan="7" class="text-center">لا توجد عمليات في محطة التمريض</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
