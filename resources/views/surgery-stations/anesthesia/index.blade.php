        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">محطة التخدير</h3>
                </div>
                <div class="card-body">
                    @if(session('success'))
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $rowClass }}">
                                    ...
                                    <td>{{ $surgery->anesthesiaStation?->anesthesiologist?->user?->full_name ?? '-' }}</td>
                                    <td>
                                        @if(!$surgery->anesthesiaStation)
                                            <span class="badge badge-secondary">في الانتظار</span>
                                        @elseif($surgery->anesthesiaStation->status === 'pending')
                                ...
                                @empty
                                <tr>
                                    <td colspan="7" class="text-center">لا توجد عمليات في محطة التخدير</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
