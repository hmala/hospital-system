            ...
            <div class="card border-warning shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">
                        ...
                        زيارات تحتاج حجز عملية ({{ $needsSurgeryVisits->count() }})
                    </h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach($needsSurgeryVisits as $visit)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('surgeries.create', ['visit_id' => $visit->id, 'patient_id' => $visit->patient_id, 'doctor_id' => $visit->doctor_id, 'department_id' => $visit->department_id]) }}" 
