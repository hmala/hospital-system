...
### 1. **اختيار متعدد للخدمات**
- ✅ **يمكن الآن اختيار أكثر من خدمة واحدة في نفس الوقت** لنفس المريض
- ✅ اختيار تحاليل + أشعة + كشف طبي في طلب واحد
- ✅ كل خدمة تُعالج بشكل منفصل ولكن في نفس العملية
- ✅ رسالة نجاح تجمع جميع الطلبات المُنشأة

### 2. اختيار أنواع التحاليل
...
### 4. التحديثات على نظام الكشف الطبي
- ✅ لم يتغير، يعمل كما كان سابقاً (اختيار طبيب وعيادة وتاريخ)
- ✅ يمكن دمجه مع خدمات أخرى في نفس الطلب
- ✅ يتم حجز موعد مباشرة ثم تحويل المريض للكاشير

## سير العمل

### سيناريو 1: طلب متعدد الخدمات
1. الموظف في الاستعلامات يختار المريض
2. **يختار عدة خدمات معاً:** تحاليل + أشعة + كشف طبي
3. لكل خدمة مختارة، يظهر النموذج المناسب:
   - للتحاليل: اختيار أنواع التحاليل المطلوبة
   - للأشعة: اختيار أنواع الأشعة المطلوبة
   - للكشف: اختيار الطبيب والعيادة
4. يضيف وصف للحالة (إذا لزم الأمر)
5. يرسل الطلب
6. **النظام ينشئ:**
   - موعد للكشف الطبي
   - زيارة وطلب للتحاليل مع الأنواع المختارة
   - زيارة وطلب للأشعة مع الأنواع المختارة
   - رسالة نجاح تجمع جميع الطلبات

### سيناريو 2: طلب تحاليل فقط
1. الموظف في الاستعلامات يختار المريض
